...
<body style="margin-left:2vw; margin-right:2vw; width:96vw">
    ...
    <h3>Product has been added to the Products table</h3>

<?php
if(!($stmt = $mysqli->prepare("INSERT INTO products (price, name, description, ingredients, sellerID) VALUES (?,?,?,?,?)"))){
    echo "Prepare failed: "  . $stmt->errno . " " . $stmt->error;
}
if(!($stmt->bind_param("dsssi",$_POST['price'],$_POST['name'],$_POST['description'],$_POST['ingredients'],$_POST['sellerID']))){
