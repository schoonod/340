...
<body style="margin-left:2vw; margin-right:2vw; width:96vw">
    ...
    <h3>Seller has been added to the Seller table</h3>

<?php
if(!($stmt = $mysqli->prepare("INSERT INTO seller (rating, userID) VALUES (?,?)"))){
    echo "Prepare failed: "  . $stmt->errno . " " . $stmt->error;
}
if(!($stmt->bind_param("ii",$_POST['rating'],$_POST['userEmail']))){
