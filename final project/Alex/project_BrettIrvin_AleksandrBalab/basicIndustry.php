...
if(!($stmt->bind_param("s",$_POST['basicIndustry']))){
...
if(!$stmt->bind_result($title,$emp_option,$salary,$experience,$notes,$app_st,$address,$name,$industry,$fname,$lname,$phone,$email,$cName)){
