...
if(!($stmt->bind_param("i",$_POST['basicSalary']))){
...
if(!empty($_POST['lowerBasicSalary'])){
if(!($stmt = $mysqli->prepare("
SELECT 
j.title,
j.emp_option,
...
if(!($stmt->bind_param("i",$_POST['lowerBasicSalary']))){
	echo "Bind failed: "  . $stmt->errno . " " . $stmt->error;
}
...
if(!empty($_POST['lowerAmount'] AND $_POST['Higher_Amount'])){
if(!($stmt = $mysqli->prepare("
SELECT 
j.title,
j.emp_option,
...
if(!($stmt->bind_param("ii",$_POST['lowerAmount'],$_POST['Higher_Amount']))){
	echo "Bind failed: "  . $stmt->errno . " " . $stmt->error;
}
